...
sc %SC_CMD% %SERVICE_NAME% binPath= "\"%SERVICE_BIN%\"" start= %SERVICE_START_TYPE% DisplayName= "LavApollo Service"

rem Set the description of the service
sc description %SERVICE_NAME% "LavApollo is a self-hosted game stream host for Moonlight."
